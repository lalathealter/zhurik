...
В полях ответов (но не вопросов и ведущих к ним веткам!) вы можете использовать разметку *MarkDown* для украшения текста и вставки гиперссылок. Как пользоваться этой разметкой можно прочитать по следующей ссылке: [https://ru.wikipedia.org/wiki/Markdown](https://ru.wikipedia.org/wiki/Markdown)
Написать тестовый пример с данной разметкой можно на сайте: [https://markdownlivepreview.com/](https://markdownlivepreview.com/)
